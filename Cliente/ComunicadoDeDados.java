public class ComunicadoDeDados extends Comunicado {
  ...
  public ComunicadoDeDados(Palavra palavra, Tracinhos tracinhos, ControladorDeErros controladorDeErros, ControladorDeLetrasJaDigitadas controladorDeLetrasJaDigitadas) {
